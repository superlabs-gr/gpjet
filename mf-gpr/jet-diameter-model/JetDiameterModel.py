...
if __name__=="__main__":
    ...
    for i in list:
        ...
        Temper.append(t)
    print(Radius)
    np.savetxt("C:/Users/thano/Desktop/ComputerVisionMEW_Paper/Geometrical_models/Jet Diameters Model/ModelDiameters.csv",np.array(Radius),delimiter=',')
